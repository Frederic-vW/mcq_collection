$(window).on('load', function() {
    ...
    ["A motor unit can contain dozens of muscle fibres",
     "A motor unit can contain tens of motor neurons",
     "Larger motor units can produce larger forces than smaller ones",
     "According to the size principle, small motor units are activated earlier"],
    ["Longer sarcomeres produce larger forces",
     "When a fibre is passively stretched, the tension increases",
     "Total tension = passive (stretch) + active (contraction) tension",
     "Active tension is maximal at an intermediate sarcomere length"]
    ]
    blank = String.fromCharCode(160)

    // find Moodle html elements
    video = document.getElementsByTagName('video')[0]
    if (video.getAttribute('title') == '03_Skeletal_ForceRegulation_2023') {
    ...
    function get_feedback(q, e, c) {
        _ = "Xz1bIkFEIiwiQUNEIiwiQkNEIl07Y2E9Xy5tYXAoX189PkFycmF5LmZyb20oX18pKQ=="
