$(window).on('load', function() {
    ...
    ["The smooth muscle myosin head phosphorylates itself when activated",
     "Some smooth muscle cells can act as pacemaker cells",
     "Calmodulin dephosphorylates the ATP needed for contraction",
     "Calmodulin is the smooth muscle calcium sensing molecule"],
    ["Smooth muscle is the fastest of the 3 muscle types",
     "Smooth muscle cells can contract for hours without relaxing",
     "The myosin light chain phosphatase is involved in relaxation",
     "Smooth muscle cells use a Na+/Ca2+ exchanger to lower cytosolic Ca2+"]
    ]
    blank = String.fromCharCode(160)

    // find Moodle html elements
    video = document.getElementsByTagName('video')[0]
    if (video.getAttribute('title') == '05_Smooth_ECcoupling_2023') {
    ...
    function get_feedback(q, e, c) {
        _ = "Xz1bIkFDRCIsIkJEIiwiQkNEIl07Y2E9Xy5tYXAoX189PkFycmF5LmZyb20oX18pKQ=="
